...
lineChartOutput <- function(inputId, width="100%", height="100%") {
  ...
  tagList(
    ...
    singleton(tags$head(
      tags$script(src= 'https://d3js.org/d3.v3.min.js'),#"d3/d3.v3.min.js"),
      tags$script(src= "nvd3/nv2.d3.js"),#"nvd3/nv2.d3.js"),
      tags$link(rel="stylesheet", type="text/css", href="nvd3/nv2.d3.css"),
